...
// NewGitlabAutoDevopsExampleAPI creates a new GitlabAutoDevopsExample instance
func NewGitlabAutoDevopsExampleAPI(spec *loads.Document) *GitlabAutoDevopsExampleAPI {
	return &GitlabAutoDevopsExampleAPI{
...
/*GitlabAutoDevopsExampleAPI This is a sample server Petstore server.  You can find out more about     Swagger at [http://swagger.io](http://swagger.io) or on [irc.freenode.net, #swagger](http://swagger.io/irc/).      For this sample, you can use the api key `special-key` to test the authorization     filters. */
type GitlabAutoDevopsExampleAPI struct {
	spec            *loads.Document
...
func (o *GitlabAutoDevopsExampleAPI) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *GitlabAutoDevopsExampleAPI) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *GitlabAutoDevopsExampleAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *GitlabAutoDevopsExampleAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *GitlabAutoDevopsExampleAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *GitlabAutoDevopsExampleAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *GitlabAutoDevopsExampleAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *GitlabAutoDevopsExampleAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *GitlabAutoDevopsExampleAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the GitlabAutoDevopsExampleAPI
func (o *GitlabAutoDevopsExampleAPI) Validate() error {
...
func (o *GitlabAutoDevopsExampleAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *GitlabAutoDevopsExampleAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *GitlabAutoDevopsExampleAPI) Authorizer() runtime.Authorizer {
	return o.APIAuthorizer
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *GitlabAutoDevopsExampleAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *GitlabAutoDevopsExampleAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *GitlabAutoDevopsExampleAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the gitlab auto devops example API
func (o *GitlabAutoDevopsExampleAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *GitlabAutoDevopsExampleAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/healthz"] = health.NewGetHealth(o.context, o.HealthGetHealthHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
...
func (o *GitlabAutoDevopsExampleAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *GitlabAutoDevopsExampleAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
...
func (o *GitlabAutoDevopsExampleAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *GitlabAutoDevopsExampleAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *GitlabAutoDevopsExampleAPI) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
