...
import (
	...
	"github.com/AlexsJones/go-openapi/restapi/operations/pet"
	"github.com/AlexsJones/go-openapi/restapi/operations/store"
	"github.com/AlexsJones/go-openapi/restapi/operations/user"
)

//go:generate swagger generate server --target ../../gitlab-auto-devops-example --name GitlabAutoDevopsExample --spec ../static/swagger.yaml --principal interface{} --exclude-main

func configureFlags(api *operations.GitlabAutoDevopsExampleAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.GitlabAutoDevopsExampleAPI) http.Handler {
